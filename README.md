...
Implementasi komponen WebView untuk menampilkan website dalam aplikasi.

<p align="center"><img src="https://github.com/harisfi/MyWebView/blob/master/mywebview_ss.png?raw=true" width="250"/></p>
...
1. Clone the repo
   ```sh
   git clone https://github.com/harisfi/MyWebView.git
   ```
...
Repo Link: https://github.com/harisfi/MyWebView
